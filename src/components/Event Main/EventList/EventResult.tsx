  ...
  return (
    ...
    >
      <CardHeader
        ...
        title={`Event: ${event?.classifications[0]?.genre?.name} , Type: ${
          event?.classifications[0]?.segment?.name || "Mix"
        }`}
      />
      <>
        <CardMedia
          sx={
            event?._embedded.attractions[1] !== undefined
              ? { height: 140 }
              : { height: 280 }
          }
      ...
      <CardContent>
        ...
        <Typography gutterBottom variant="h6" component="div">
          ...
          at {moment(event?.dates?.start?.localTime, "h/m/s").format("hh:mm A")}{" "}
        </Typography>
        <h4>
          {" "}
