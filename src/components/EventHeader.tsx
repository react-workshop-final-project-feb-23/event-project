          ...
          <Toolbar>
            ...
            <Typography variant='h6' component='span' sx={{ flexGrow: 1 }}>
              <Link href='/favorites' underline='hover'>
                <h1>
                  <FavoriteIcon style={{ color: 'yellow', fontSize: 50, paddingRight: 10 }} fontSize='large' />
                  Bucket List
                </h1>
              </Link>
            </Typography>
            <Typography variant='h6' component='span' sx={{ paddingRight: 2 }}>
              <h1>
                <PersonIcon style={{ color: 'black', fontSize: 50, paddingRight: 10 }} fontSize='large' /> {userName}
              </h1>
            </Typography>
            <Button
              variant='contained'
